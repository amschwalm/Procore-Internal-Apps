...
3. **Overview** — 30-day agent conversation volume (with month-over-month), a Timeline with toggles for call sentiment / new users / weekly conversations, the user-type ladder, Areas of Interest, and Growth Areas Identified. Use **Load sample** to preview without a key, **Load sample sentiment** for the Timeline, or **Sync Datagrid** / **Sync Slack** after keys are saved. Upload an insights Excel/CSV to classify people and rank Areas of Interest.
